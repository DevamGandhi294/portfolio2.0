  ...
  return (
    <main className="min-h-screen">
      ...
      <div className="relative h-screen w-full">
        <Spline
          scene="https://prod.spline.design/BK3mVotXxDiZcE-C/scene.splinecode"
          className="absolute inset-0"
        />
        {/* Overlay content */}
        <div className="absolute inset-0 flex items-center justify-center">
          <div className="text-center text-primary z-10 animate-fade-in">
            <h1 className="text-5xl md:text-7xl font-bold mb-2">About Me</h1>
            <p className="text-xl md:text-2xl mb-8 text-dark">Computer Engineering Student & Developer</p>
          </div>
        </div>
      </div>
              ...
              <FloatingElement delay={1.2}>
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-gray-300">Udhana, Surat (394210), Gujarat, India</p>
                  </div>
                </div>
              </FloatingElement>
